...
divvy_json["stationBeanList"].each do |station|
	...
	elsif station["availableBikes"].to_i < station["totalDocks"] / 4
		quarter_full_count = quarter_full_count + 1
	elsif station["availableBikes"].to_i < station["totalDocks"] / 2
		half_full_count = half_full_count + 1
	elsif station["availableBikes"].to_i < station["totalDocks"] * 3/4 
